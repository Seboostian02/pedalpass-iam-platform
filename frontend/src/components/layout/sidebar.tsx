...
const NAV_ITEMS = [
  { icon: LayoutDashboard, labelKey: 'layout.dashboard', path: ROUTES.DASHBOARD, roles: [], permissions: [] },
  { icon: Users, labelKey: 'layout.users', path: ROUTES.USERS, roles: [ROLES.ADMIN], permissions: ['user:read'] },
  { icon: Server, labelKey: 'layout.resources', path: ROUTES.RESOURCES, roles: [], permissions: [] },
  { icon: FileCheck, labelKey: 'layout.accessRequests', path: ROUTES.ACCESS_REQUESTS, roles: [], permissions: [] },
  { icon: Shield, labelKey: 'layout.auditSecurity', path: ROUTES.AUDIT, roles: [ROLES.ADMIN, ROLES.SECURITY_OFFICER], permissions: [] },
  { icon: Bell, labelKey: 'layout.notifications', path: ROUTES.NOTIFICATIONS, roles: [], permissions: [] },
  { icon: User, labelKey: 'layout.profile', path: ROUTES.PROFILE, roles: [], permissions: [] },
];
...
export function Sidebar({ side = 'left' }: SidebarProps) {
  ...
  console.log('[Sidebar] Visible items:', visibleItems.map((i) => i.labelKey));
