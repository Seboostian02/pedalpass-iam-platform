      ...
      <Tabs defaultValue="all">
        <TabsList className="w-full sm:w-auto">
          <TabsTrigger value="all" className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline">{t('notifications.allLabel')}</span> {t('notifications.allNotifications')}
          </TabsTrigger>
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        {notification.emailSent && (
                          <span className="ml-2 inline-flex items-center gap-1">
                            <Mail className="h-3 w-3" /> {t('common.emailSent')}
                          </span>
                        )}
                      </p>
                    </div>
        ...
        <TabsContent value="preferences" className="space-y-4">
          {preferencesQuery.isLoading ? (
            ...
            <EmptyState
              ...
              title={t('notifications.noPreferencesYet')}
              description={t('notifications.noPreferencesDescription')}
            />
          ) : (
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">{t('notifications.preferencesTitle')}</CardTitle>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead>{t('notifications.notificationType')}</TableHead>
                      ...
                      <TableHead className="text-center">
                        <span className="flex items-center justify-center gap-1">
                          <BellRing className="h-4 w-4" /> {t('notifications.inApp')}
                        </span>
                      </TableHead>
                    </TableRow>
                  </TableHeader>
